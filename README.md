Este é um projeto para mostrar as cidades de origem de alguns funcionários e de um estudante(no caso eu) da Practicum. Pode ser visualizado em diversos tamanhos de tela (1280px, 768px, 320px).
